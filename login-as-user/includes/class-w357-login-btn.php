...
class LoginAsUserButton_Generator
{
    ...
    /**
     * The HTML tags and attributes allowed in the markup generated by this class.
     *
     * Based on the standard post allowlist, plus `tabindex` which the accessible
     * tooltip needs but which `wp_kses_post()` would otherwise strip out.
     *
     * @return array
     */
